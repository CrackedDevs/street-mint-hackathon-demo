    ...
    <div className="bg-white">
      ...
      <main className="isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Create, mint, and share unique NFTs and POAPs on Solana with the power of NFC technology.
                </p>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Street Mint combines the power of Solana blockchain with NFC technology to bring your digital collectibles into the physical world.
            </p>
          </div>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              {[
                ...
                },
                {
                  ...
                  description: "Leverage the speed and efficiency of the Solana blockchain for your digital collectibles.",
                  icon: ChevronRight
                }
              ].map((feature, index) => (
              ...
              {[
                {
                  ...
                  description: "Log in to Street Mint and create your unique NFT collection on the Solana blockchain."
                },
                {
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
              Join Street Mint today and start creating unforgettable experiences with your NFTs and POAPs.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
      ...
      <footer className="mx-auto mt-40 max-w-7xl overflow-hidden px-6 pb-20 sm:mt-64 sm:pb-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; {new Date().getFullYear()} Street Mint, Inc. All rights reserved.
        </p>
      </footer>
    </div>
  )
