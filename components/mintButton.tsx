...
import { CheckIcon, CopyIcon, ExternalLink, HeartIcon, ImageIcon, Unplug, Wallet } from "lucide-react";
...
export default function MintButton({
  ...
  const { connected, connect, publicKey, signTransaction, select, disconnect, connecting } = useWallet();
              ...
              {isFreeMint ? (
                <div className="w-full flex flex-col items-center justify-center">
                  ...
                  <WhiteBgShimmerButton
                    ...
                    disabled={isMinting || !isEligible || existingOrder || (isFreeMint && !walletAddress) || isLoading}
                  >
                    {getButtonText()}
                  </WhiteBgShimmerButton>
                </div>
